...
install -m 0755 "$SRC/host/sysroot/usr/bin/pair-keys-sync" /usr/bin/pair-keys-sync
runuser -u "$ADMIN_USER" -- env "TRUST_ROOT_USER=$TRUST_ROOT_USER" /usr/bin/pair-keys-sync \
