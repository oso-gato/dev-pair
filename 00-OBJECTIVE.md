...
- **The dev-container** — develop and validate (tier-1); the platform's **sole merge authority** under its empirical gates — except the charter, maintainer-merge-only; home of the multi-tenant sessions; refreshed from outside, by the host.
